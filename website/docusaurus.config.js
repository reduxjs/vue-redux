...
const siteConfig = {
    ...
    [
      "@docusaurus/preset-classic",
      {
        docs: {
          ...
          editUrl: "https://github.com/reduxjs/vue-redux/edit/main/website",
  ...
  title: "Vue Redux", // Title for your website.
  onBrokenLinks: "throw",
  tagline: "Official Vue bindings for Redux",
  url: "https://vue-redux.js.org", // Your website URL
  baseUrl: "/",
  // Used for publishing and more
  projectName: "vue-redux",
  ...
  customFields: {
    repoUrl: "https://github.com/reduxjs/vue-redux",
  },
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: "https://www.github.com/reduxjs/vue-redux",
          label: "GitHub",
          position: "right",
          className: "github",
        },
      ...
      links: [
          ...
          items: [
            {
              ...
              href: "https://stackoverflow.com/questions/tagged/vue-redux",
            },
            {
              label: "Discord",
        ...
        },
        {
          ...
          items: [
            {
              label: "GitHub",
              href: "https://github.com/reduxjs/vue-redux",
            },
            {
              html: `
                <a
                  ...
                  data-count-href="/reduxjs/vue-redux/stargazers"
