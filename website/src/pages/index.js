...
const features = [
  {
    content: (
      <p>
        Vue Redux is maintained by the Redux team, and{" "}
        <strong>
          kept up-to-date with the latest APIs from Redux and Vue
        </strong>
        .
      </p>
    ),
  ...
  },
  {
    content: (
      <p>
        <strong>Designed to work with Vue's component model</strong>. You
